...
const Complaints = () => {
  document.title = 'Utilitiessave - Complaint Procedure'
  return (
    <div className='flex flex-col items-center gap-10 max-w-[100%] pb-10 '>
      ...
      <section className='flex flex-col max-w-[1080px] lg:py-20 '>
        <motion.div
          initial={{ opacity: 0, x: -100 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 1 }}
          className='flex flex-col px-5 text-base font-medium lg:text-lg'
        >
          <h1 className='text-xl font-extrabold text-center lg:text-left'>
          ...
          <p>
            ...
            <br /> <br />
            Please contact us via any of the following Utilities Save complaints
            services :
            <br /> <br />
            ...
            <br /> <br />
            <p>
              When we receive a complaint from you, we initiate the following in
              order to resolve your complaint: We will consider your complaint
              by the close of business on the third working day after receiving
              your complaint and, if possible, provide a suitable verbal
              explanation within the time frame. lf we cannot resolve your
              complaint by the third business day we will, within five working
              days, provide you with a written acknowledgement of receipt of
              your complaint and will also endeavour to provide a resolution by
              then. lf we have been unable to resolve your complaint by this
              time, we will advise you when <br /> <br />
              We expect to be able to reach a conclusion, with the aim of
              providing a final resolution as soon as possible. lf a final
              response cannot be completed within eight weeks, we will mail you
              explaining why we are not in a position to provide a final
          ...
          <br />
          <h2 className='font-bold underline text-tealGreen'>
