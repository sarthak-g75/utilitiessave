...
const QuoteForm = () => {
  ...
  return (
    <section className='flex flex-col items-center justify-center w-full py-10 pb-16 mt-0 border-b lg:mt-32 border-tealGreen/10 bg-tealGreen'>
      <div className='flex flex-col items-center text-center lg:text-left lg:items-start px-5  lg:gap-8 lg:flex-row justify-center lg:max-w-[1240px] w-full max-w-[700px]'>
